...
export default async function handler(req, res) {
  let { pr_title, pr_body, block_of_code, ticket_title, ticket_body, thread_body } = req.body;
  ...
  try {    
    const codeContextSummary = await openai.createCompletion({
