...
export default async function handler(req, res) {
  ...
  let blocks = [];
  if (!workspaceRecord.fields.HasPaid) {
      ...
      data: {
        ...
        blocks: [
          ...
          },
          {
            ...
            text: {
              type: "mrkdwn",
              text: `We're sorry folks, this workspace is no longer on the paid plan :(
Please upgrade by emailing <mailto:support@watermelon.tools|support@watermelon.tools>.
We hope you enjoyed connecting with your coworkers.
Thanks for using the service :smile:`,
            },
          },
        ],
