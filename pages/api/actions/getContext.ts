...
export default async function handler(req, res) {
  ...
  .createCompletion({
    ...
    prompt: `PR 1 title: ${ghValue[0].title} \n PR 1 body: ${ghValue[0].body} \n PR 2 title: ${ghValue[1].title} \n PR 2 body: ${ghValue[1].body} \n PR 3 title: ${ghValue[2].title} \n PR 3 body: ${ghValue[2].body} \n Summarize what the 3 PRs are about. What are these 3 PRs tell us about the business logic? Don't summarize each PR separately, combine them. Don't say "these PRs", instead say "related PRs".`,
    max_tokens: 512,
    temperature: 0.7,
  })
  ...
  console.log(codeContextSummary)
